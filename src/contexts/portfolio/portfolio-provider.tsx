...
export function PortfolioProvider({
  ...
  const value = useMemo<PortfolioContextValue>(
    ...
    [
      ...
      applyCampaignFullPlanForProject,
      confirmCampaignSequenceStepForProject,
      confirmDistributionGuideStepForProject,
      toggleCampaignSequenceStepForProject,
      setCampaignGtmMotionForProject,
      setCampaignIcpStructuredForProject,
      setCampaignAttributionQuestionForProject,
      toggleCampaignInfraGateForProject,
      toggleCampaignAssetChecklistForProject,
      addMessageMarketFitNoteForProject,
      ...
      confirmFoundationsRiverStopForProject,
      startCampaignContentStudioForProject,
      setCampaignContentAssetForProject,
      setGitHubConnection,
      setHostConnection,
      getProjectBySlug,
      getProjectById,
