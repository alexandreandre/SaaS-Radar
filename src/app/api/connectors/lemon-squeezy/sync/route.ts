...
import { LemonSqueezyConnectorError } from "@/lib/connectors/lemon-squeezy/client";
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const message = err instanceof Error ? err.message : "Synchronisation Lemon Squeezy échouée";
    return NextResponse.json(
      { error: message },
