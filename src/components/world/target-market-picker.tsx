  ...
  return (
    <div
      className={cn(
        ...
        discrete
          ? "gap-2 rounded-lg border border-border bg-muted/40 px-2.5 py-1.5"
    ...
    >
      <div
        className={cn(
          ...
          discrete ? "text-[11px] text-muted-foreground" : "text-sm text-foreground/80"
        )}
      >
        <Target className={cn("shrink-0 text-primary", discrete ? "h-3 w-3" : "h-4 w-4")} />
        {!discrete && <span className="font-medium text-foreground">Je lance sur</span>}
      ...
      <div className={cn("relative", discrete ? "min-w-[130px]" : "min-w-[200px] flex-1 sm:min-w-[240px]")}>
        <select
          ...
          className={cn(
            "w-full cursor-pointer appearance-none rounded-lg border border-border bg-muted/60 font-medium text-foreground focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary",
      ...
      {!discrete && (
        <p className="w-full text-[11px] leading-snug text-muted-foreground sm:w-auto sm:max-w-xs">
