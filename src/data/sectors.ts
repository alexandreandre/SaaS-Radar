...
export const sectorCatalog: SectorCatalogEntry[] = [
  ...
  { id: "saas-b2b", label: "SaaS B2B vertical", group: "Tech", keywords: ["micro saas", "niche"] },
  ...
  { id: "childcare", label: "Petite enfance", group: "Éducation", keywords: ["creche", "micro creche"] },
