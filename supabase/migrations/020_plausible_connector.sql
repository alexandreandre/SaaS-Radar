-- Étendre les providers connecteurs pour Plausible (clé Stats API utilisateur)
...
alter table public.connector_credentials
  ...
  check (provider in ('github', 'vercel', 'netlify', 'stripe', 'google-ads', 'meta-ads', 'plausible'));
